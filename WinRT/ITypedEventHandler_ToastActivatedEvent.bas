Attribute VB_Name = "ITEH_ToastActivatedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_UI_Notifications_ToastNotification_IInspectable = "{ab54de2d-97d9-5528-b6ad-105afe156530}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_UI_Notifications_ToastNotification_IInspectable)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Dim ToastActivatedEventArgs As New ToastActivatedEventArgs
    ToastNotification.Ifc = sender
    ToastActivatedEventArgs.Ifc = args
    Call m_Object.ToastActivatedEvent(ToastNotification, ToastActivatedEventArgs)
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub ToastActivatedEvent(ByVal sender As ToastNotification, ByVal args As ToastActivatedEventArgs)"
    Resume PROC_EXIT
End Function
