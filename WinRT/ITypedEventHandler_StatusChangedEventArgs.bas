Attribute VB_Name = "ITEH_StatusChangedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Devices_Geolocation_StatusChangedEventArgs = "{97fcf582-de6b-5cd3-9690-e2ecbb66da4d}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Devices_Geolocation_StatusChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        Dim StatusChangedEventArgs As New StatusChangedEventArgs
        StatusChangedEventArgs.Ifc = args
        Call m_Object.DeviceSelectedEvent(sender, StatusChangedEventArgs)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub StatusChangedEvent(ByVal sender As Long, ByVal args As StatusChangedEventArgs)"
    Resume PROC_EXIT
End Function
