Attribute VB_Name = "ITEH_PlaybackInfoChanged"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_PlaybackInfoChangedEventArgs As String = "{2bdf1426-d41f-5896-897f-efc0b0fa7392}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_PlaybackInfoChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Call m_Object.PlaybackInfoChangedEvent(sender, args)
PROC_EXIT:
    Exit Function
PROC_ERR:
