Attribute VB_Name = "ITEH_MediaFailed"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Playback_MediaPlayer_MediaPlayerFailedEventArgs = "{362c45a7-3a0a-5e27-99ce-cff6d1b770e1}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Playback_MediaPlayer_MediaPlayerFailedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If Not m_Object Is Nothing Then
        Call m_Object.MediaFailedEvent(sender, args)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
