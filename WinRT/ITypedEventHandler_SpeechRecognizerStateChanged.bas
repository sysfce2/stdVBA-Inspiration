Attribute VB_Name = "ITEH_SpeechRecognizerStateChanged"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_SpeechRecognition_SpeechRecognizerStateChangedEventArgs = "{d1185e92-5c30-5561-b3e2-e82ddbd872c3}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_SpeechRecognition_SpeechRecognizerStateChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If Not m_Object Is Nothing Then
        Call m_Object.SpeechRecognizerStateChangedEvent(sender, args)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
