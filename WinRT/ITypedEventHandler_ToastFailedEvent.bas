Attribute VB_Name = "ITEH_ToastFailedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_UI_Notifications_ToastNotification_ToastFailedEventArgs = "{95e3e803-c969-5e3a-9753-ea2ad22a9a33}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_UI_Notifications_ToastNotification_ToastFailedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Dim ToastFailedEventArgs As New ToastFailedEventArgs
    ToastNotification.Ifc = sender
    ToastFailedEventArgs.Ifc = args
    Call m_Object.ToastFailedEvent(ToastNotification, ToastFailedEventArgs)
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub ToastFailedEvent(ByVal sender As ToastNotification, ByVal args As ToastFailedEventArgs)"
    Resume PROC_EXIT
End Function
