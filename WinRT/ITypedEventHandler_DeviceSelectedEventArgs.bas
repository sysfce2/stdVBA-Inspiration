Attribute VB_Name = "ITEH_DeviceSelectedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Devices_Enumeration_DeviceSelectedEventArgs = "{47e48c88-1c56-5b58-96a2-8e813d25077a}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Devices_Enumeration_DeviceSelectedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        Dim DeviceSelectedEventArgs As New DeviceSelectedEventArgs
        DeviceSelectedEventArgs.Ifc = args
        Call m_Object.DeviceSelectedEvent(sender, DeviceSelectedEventArgs)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
