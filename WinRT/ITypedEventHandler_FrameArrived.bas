Attribute VB_Name = "ITEH_FrameArrived"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Graphics_Capture_Direct3D11CaptureFramePool_IInspectable = "{51a947f7-79cf-5a3e-a3a5-1289cfa6dfe8}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Graphics_Capture_Direct3D11CaptureFramePool_IInspectable)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If Not m_Object Is Nothing Then
        Call m_Object.FrameArrivedEvent(sender, args)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub FrameArrivedEvent(ByVal sender As Long, ByVal args As long)"
    Resume PROC_EXIT
End Function
