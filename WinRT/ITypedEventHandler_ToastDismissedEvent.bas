Attribute VB_Name = "ITEH_ToastDismissedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_UI_Notifications_ToastNotification_ToastDismissedEventArgs = "{61c2402f-0ed0-5a18-ab69-59f4aa99a368}"
...
Public Function Create(ByVal o As Object) As Long
    Set m_Object = o
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_UI_Notifications_ToastNotification_ToastDismissedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Dim ToastNotification As New ToastNotification
    Dim ToastDismissedEventArgs As New ToastDismissedEventArgs
    ToastNotification.Ifc = sender
    ToastDismissedEventArgs.Ifc = args
    Call m_Object.ToastDismissedEvent(ToastNotification, ToastDismissedEventArgs)
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub ToastDismissedEvent(ByVal sender As ToastNotification, ByVal args As ToastDismissedEventArgs)"
    Resume PROC_EXIT
End Function
