Attribute VB_Name = "ITEH_CastingDevicePickerDismissed"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Casting_CastingDevicePicker_IInspectable = "{a64b972b-aa63-5c61-9cde-cd6ffea8a247}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Casting_CastingDevicePicker_IInspectable)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        ...
        Call m_Object.CastingDevicePickerDismissedEvent(sender, Inspectable)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
