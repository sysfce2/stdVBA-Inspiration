...
' ----==== Const ====----
Private Const IID_ITimerElapsedHandler = "{faaea667-fbeb-49cb-adb2-71184c556e43}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(IID_ITimerElapsedHandler)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Call m_Object.Invoke_TimerElapsed(pTimer)
End Function
