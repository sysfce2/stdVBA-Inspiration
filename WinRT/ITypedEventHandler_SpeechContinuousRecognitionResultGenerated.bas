Attribute VB_Name = "ITEH_SpeechContinuousRecognitionResultGenerated"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_SpeechRecognition_SpeechContinuousRecognitionResultGeneratedEventArgs = "{26192073-a2c9-527d-9bd3-911c05e0011e}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_SpeechRecognition_SpeechContinuousRecognitionResultGeneratedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If Not m_Object Is Nothing Then
        Call m_Object.SpeechContinuousRecognitionResultGeneratedEvent(sender, args)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
