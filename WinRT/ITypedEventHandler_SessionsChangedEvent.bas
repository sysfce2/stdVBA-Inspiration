Attribute VB_Name = "ITEH_SessionsChangedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSessionManager_SessionsChangedEventArgs As String = "{2e2a8630-dc8c-530a-9746-bc984d4b029e}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSessionManager_SessionsChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Call m_Object.SessionsChangedEvent(sender, args)
PROC_EXIT:
    Exit Function
PROC_ERR:
