Attribute VB_Name = "ITEH_TimelinePropertiesChanged"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_TimelinePropertiesChangedEventArgs As String = "{e8bf62af-fac1-5fff-9053-0bf191ae777e}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_TimelinePropertiesChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Call m_Object.TimelinePropertiesChangedEvent(sender, args)
PROC_EXIT:
    Exit Function
PROC_ERR:
