Attribute VB_Name = "ITEH_DeviceDisconnectButtonClickedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Devices_Enumeration_DeviceDisconnectButtonClickedEventArgs = "{35dd0319-5723-506c-8896-1a28b82be798}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Devices_Enumeration_DeviceDisconnectButtonClickedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        Dim DeviceDisconnectButtonClickedEventArgs As New DeviceDisconnectButtonClickedEventArgs
        DeviceDisconnectButtonClickedEventArgs.Ifc = args
        Call m_Object.DeviceDisconnectButtonClickedEvent(sender, DeviceDisconnectButtonClickedEventArgs)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
