Attribute VB_Name = "ITEH_UserNotificationChangedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_UI_Notifications_Management_UserNotificationListener_UserNotificationChangedEventArgs = "{10242902-b897-5507-9922-2c0a7d34464d}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_UI_Notifications_Management_UserNotificationListener_UserNotificationChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        Dim UserNotificationChangedEventArgs As New UserNotificationChangedEventArgs
        UserNotificationChangedEventArgs.Ifc = args
        Call m_Object.UserNotificationChangedEvent(sender, UserNotificationChangedEventArgs)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.name & "' must contain the following function: " & _
                "Public Sub UserNotificationChangedEvent(ByVal sender As Long, ByVal args As UserNotificationChangedEventArgs)"
    Resume PROC_EXIT
End Function
