Attribute VB_Name = "ITEH_PositionChangedEvent"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Devices_Geolocation_PositionChangedEventArgs = "{df3c6164-4e7b-5e8e-9a7e-13da059dec1e}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Devices_Geolocation_PositionChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    If args <> 0& Then
        Dim PositionChangedEventArgs As New PositionChangedEventArgs
        PositionChangedEventArgs.Ifc = args
        Call m_Object.DeviceSelectedEvent(sender, PositionChangedEventArgs)
    End If
PROC_EXIT:
    Exit Function
PROC_ERR:
    Debug.Print "Error: The object '" & m_Object.Name & "' must contain the following function: " & _
                "Public Sub PositionChangedEvent(ByVal sender As Long, ByVal args As PositionChangedEventArgs)"
    Resume PROC_EXIT
End Function
