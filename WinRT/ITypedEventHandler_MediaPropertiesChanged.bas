Attribute VB_Name = "ITEH_MediaPropertiesChanged"
...
' ----==== Const ====----
Private Const ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_MediaPropertiesChangedEventArgs As String = "{0f2ce2b7-afa7-5ed0-8cb6-8c40cf9b3a5f}"
...
Private Function QueryInterface(ByVal this As Long, _
    ...
    Case UCase$(IID_IUnknown), UCase$(ITypedEventHandler_Windows_Media_Control_GlobalSystemMediaTransportControlsSession_MediaPropertiesChangedEventArgs)
        Call AddRef(this)
...
Private Function Invoke(ByVal this As Long, _
    ...
    Call m_Object.MediaPropertiesChangedEvent(sender, args)
PROC_EXIT:
    Exit Function
PROC_ERR:
